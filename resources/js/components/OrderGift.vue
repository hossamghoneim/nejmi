                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-12 mt-2">
                                                        <div class="form-row">
                                                            ...
                                                            <input type="text" max="191" v-model="order.from" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 mt-2">
                                                        <div class="form-row">
                                                            ...
                                                            <input type="text" max="191" class="form-control" v-model="order.to" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row col-md-12 input_wrapper">
                                                        <label class="form-control-label">
                                                            رسالتك
                                                        </label>
                                            ...
                                            <div v-if="form == 2" >
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div v-if="coupon.notValid" class="alert alert-warning mx-auto my-3 w-50">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div v-if="phoneRequired" class="alert alert-danger w-50 mt-2">رقم الهاتف إجباري</div>
                                                    </div>
                                                </div>
                                                <div class="row">
...
export default {
    mounted() {
        ...
        axios.get("/request/get-target/" + id + "/gift")
        .then((res) => {
            if(res.data == 0)
        ...
        axios.get("/request/get-gifts").then((res) => {
